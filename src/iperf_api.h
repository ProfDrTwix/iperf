...
#define OPT_MSG_OOB MSG_OOB
#define OPT_MSG_PEEK	MSG_PEEK
#define OPT_MSG_DONTROUTE	MSG_DONTROUTE
#ifdef __USE_GNU
    /* DECnet uses a different name.  */
#define OPT_MSG_TRYHARD	MSG_DONTROUTE
#endif

#ifdef QNX_NOT_SUPPORTED
#define OPT_MSG_ZEROCOPY	MSG_ZEROCOPY
#define OPT_MSG_SYN		MSG_SYN
#define OPT_MSG_RST		MSG_RST
#define OPT_MSG_MORE	MSG_MORE
#define OPT_MSG_FIN		MSG_FIN
#define OPT_MSG_ERRQUEUE	MSG_ERRQUEUE
#define OPT_MSG_CONFIRM	MSG_CONFIRM
#define OPT_MSG_CMSG_CLOEXEC MSG_CMSG_CLOEXEC
#define OPT_MSG_FASTOPEN	MSG_FASTOPEN
#define OPT_MSG_BATCH	MSG_BATCH
#endif

#define OPT_MSG_CTRUNC	MSG_CTRUNC
#define OPT_MSG_PROXY	MSG_PROXY
#define OPT_MSG_TRUNC	MSG_TRUNC
#define OPT_MSG_DONTWAIT	MSG_DONTWAIT
#define OPT_MSG_EOR		MSG_EOR
#define OPT_MSG_WAITALL	MSG_WAITALL
#define OPT_MSG_NOSIGNAL	MSG_NOSIGNAL
#define OPT_MSG_WAITFORONE	MSG_WAITFORONE
...
int iperf_open_instr_logfile(struct iperf_test *);
